          ...
          <div class="space-y-4 p-4">
            ...
            <div v-if="subscription.group?.daily_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ formatPoints(subscription.daily_usage_usd) }} / {{ formatPoints(subscription.group.daily_limit_usd) }} {{ t('common.points') }}
                </span>
              </div>
            ...
            <div v-if="subscription.group?.weekly_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ formatPoints(subscription.weekly_usage_usd) }} / {{ formatPoints(subscription.group.weekly_limit_usd) }} {{ t('common.points') }}
                </span>
              </div>
              <div class="relative h-2 overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                <div
            ...
            <div v-if="subscription.group?.monthly_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ formatPoints(subscription.monthly_usage_usd) }} / {{ formatPoints(subscription.group.monthly_limit_usd) }} {{ t('common.points') }}
                </span>
              </div>
              <div class="relative h-2 overflow-hidden rounded-full bg-gray-200 dark:bg-dark-600">
                <div
...
import { formatDateTimeToMinute, formatPoints } from '@/utils/format'
