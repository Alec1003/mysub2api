<template>
  <Teleport to="body">
    <Transition name="modal">
      <div
        v-if="show"
        class="modal-overlay brutal-modal-overlay"
        :style="zIndexStyle"
      ...
      >
        <!-- Modal panel -->
        <div ref="dialogRef" :class="['modal-content', 'brutal-modal-content', widthClasses]" @click.stop>
          <!-- Header -->
